...
func ParseContentStr(contentStr string, origContentMD5 string) (content [][]*types.Rune, contentPrefix [][]*types.Rune, contentMD5 string, ip string, host string, bbs string, signatureMD5 string, signatureDBCS string, commentsDBCS string) {
	// remove \r
