...
var (
	...
	testTheRestComments11Full []*schema.Comment
)
...
func initTest11() {
	...
	testTheRestComments11 = make([]*schema.Comment, len(testTheRestComments11Full))
	for idx, eachFull := range testTheRestComments11Full {
		each := &schema.Comment{}
		*each = *eachFull
		testTheRestComments11[idx] = each
	}
	testTheRestComments11[65].Owner = ""
	testTheRestComments11[65].IP = ""
	testTheRestComments11[65].Host = ""
	testTheRestComments11[65].EditNanoTS = 0
}
