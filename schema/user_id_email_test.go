...
func TestCreateUserIDEmail(t *testing.T) {
	...
	expected2 := &UserIDEmail{
		...
		UpdateNanoTS: 1234569890000000000,
	}
	...
	tests := []struct {
		...
		{
			args:        args{userID: "SYSOP", email: "test@ptt2.test", updateNanoTS: 1234569890000000000},
			wantErr:     true,
		...
		{
			args:     args{userID: "SYSOP", email: "test@ptt3.test", updateNanoTS: 1234569890000000000},
			expected: expected2,
		},
	}
