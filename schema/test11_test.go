...
var (
	...
	testFirstComments11     []*Comment
	testFullFirstComments11 []*Comment

	testTheRestComments11 []*Comment

	testFullTheRestComments11 []*Comment
)
...
func initTest11() {
	...
	testFirstComments11 = make([]*Comment, len(testFullFirstComments11))
	...
	testTheRestComments11 = make([]*Comment, len(testFullTheRestComments11))
